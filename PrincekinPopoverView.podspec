Pod::Spec.new do |s|
      ...
      s.source       = { :git => "https://github.com/iOSPrincekin/PrincekinPopoverView.git", :tag => "0.2.5" }
      s.source_files  = 'PrincekinPopoverView/**/*'
s.exclude_files = 'PrincekinPopoverView/*.plist'
   end